import logoSRC from "../../public/NOSWHITE_1.png";
import Link from "next/link";
import Image from "next/image";

const navigation = {
  solutions: [
    {name: "Training", href: "https://trainnos.pushpress.com/landing/plans"},
  ...
  social: [
    {
      name: "Facebook",
      href: "https://www.facebook.com/nostrainingfacility/",
      icon: props => (
    ...
    {
      name: "Instagram",
      href: "https://www.instagram.com/n.o.s.trainingfacility",
      icon: props => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <path
            fillRule="evenodd"
  ...
  return (
    <footer className="bg-slate-800">
      <div className="mx-auto max-w-7xl px-6 pb-8 pt-8 sm:pt-12 lg:px-8 lg:pt-16">
        ...
        {/* 
            The following is a newsletter form submission
        ...
        <div className="mt-8 border-t border-white/10 pt-8 md:flex md:items-center md:justify-between">
          ...
          <p className="mt-8 text-sm/6 text-gray-400 md:order-1 md:mt-0">
            &copy; 2024 No Off Season, LLC. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
